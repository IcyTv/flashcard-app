		...
		<IonContent className="tos-page">
			<div>
				...
				<p>
					...
					other intellectual property rights related to it, still belong to IcyTv (Michael Finger).
				</p>{' '}
				<p>
					IcyTv (Michael Finger) is committed to ensuring that the app is as useful and efficient as possible.
					For that reason, we reserve the right to make changes to the app or to charge for its services, at
					any time and for any reason. We will never charge you for the app or its services without making it
				...
				<p>
					...
					security features and it could mean that the Flashcard App app won’t work properly or at all.
				</p>{' '}
				<div>
				...
				<p>
					...
					connection. The connection can be Wi-Fi, or provided by your mobile network provider, but IcyTv
					(Michael Finger) cannot take responsibility for the app not working at full functionality if you
				...
				<p>
					Along the same lines, IcyTv (Michael Finger) cannot always take responsibility for the way you use
					the app i.e. You need to make sure that your device stays charged – if it runs out of battery and
					you can’t turn it on to avail the Service, IcyTv (Michael Finger) cannot accept responsibility.
				</p>{' '}
				<p>
					With respect to IcyTv (Michael Finger)’s responsibility for your use of the app, when you’re using
					...
					it available to you. IcyTv (Michael Finger) accepts no liability for any loss, direct or indirect,
				...
				<p>
					...
					app to) may change, and you’ll need to download the updates if you want to keep using the app. IcyTv
				...
				<p>
					...
					me at <a href="mailto:michael.finger@icytv.de">michael.finger@icytv.de</a>.
				</p>{' '}
			</div>
		</IonContent>
	);
