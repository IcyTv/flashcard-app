...
export const PrivacyPolicy: React.FC<PrivacyPolicyProps> = () => {
	return (
		<IonContent className="privacy-page">
			<div>
				<IonTitle>Privacy Policy</IonTitle>
				<p>
					IcyTv (Michael Finger) built the Flashcard App app as a Freemium app. This SERVICE is provided by
					IcyTv (Michael Finger) at no cost and is intended for use as is.
				</p>{' '}
				<p>
				...
				<p>
					...
					is accessible at Flashcard App unless otherwise defined in this Privacy Policy.
				</p>{' '}
				<p>
