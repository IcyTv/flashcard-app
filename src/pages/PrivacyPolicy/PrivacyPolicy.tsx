...
export const PrivacyPolicy: React.FC<PrivacyPolicyProps> = () => {
	return (
		<IonContent>
			...
			<p>
				IcyTv (Michael Finger) built the Flashcard App app as a Freemium app. This SERVICE is provided by IcyTv
				(Michael Finger) at no cost and is intended for use as is.
			</p>{' '}
			<p>
			...
			<p>
				...
				accessible at Flashcard App unless otherwise defined in this Privacy Policy.
			</p>{' '}
			<p>
			...
			<p>
				...
				provided me with personal information, I immediately delete this from our servers. If you are a parent
